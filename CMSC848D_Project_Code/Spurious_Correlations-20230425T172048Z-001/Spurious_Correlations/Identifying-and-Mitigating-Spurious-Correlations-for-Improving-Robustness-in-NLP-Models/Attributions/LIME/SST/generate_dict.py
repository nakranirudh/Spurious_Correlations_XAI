...
from data_structure import get_sst2, get_movie_rationales, get_IMDB
...
gpu0_file = "list_100samples_GPU_trainidx_trainlabel_attributes_0.pkl"
gpu1_file = "list_100samples_GPU_trainidx_trainlabel_attributes_1.pkl"
gpu2_file = "list_100samples_GPU_trainidx_trainlabel_attributes_2.pkl"
...
split_idxs = [0, 10000, 20000, split_3]
...
for i in range(len(all_data)):
	...
	for j in range(len(curr_data)):
		...
		curr_input_ids = tokenizer(dataset_df['text'][true_dataset_idx],truncation=True,add_special_tokens=False,return_tensors='pt')['input_ids']
